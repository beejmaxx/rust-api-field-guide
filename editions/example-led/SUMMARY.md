...
[Example-led edition](README.md)

# Part I · Design decisions in production
...
# Part II · Compare the decisions

- [Generic envelopes in production](02-ownership-is-api-design.md)
- [Construction safety in production](05-builders-and-typed-payloads.md)
- [Replayable retry in production](11-retry-and-replayability.md)

# Part III · Generalize the principles
...
# Part IV · Compare across ecosystems
...
- [Twelve design decisions at a glance](case-studies/README.md)
