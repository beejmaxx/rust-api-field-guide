...
function Introduction() {
  ...
  return <article className="book-page intro-page">
    ...
    <p className="lede">A practical guide to designing Rust APIs by reading the standard library and exemplary open-source crates.</p>
    <div className="intro-rule"><span>12 chapters</span><span>20+ APIs</span><span>About 11 hours</span></div>
    <section id="about"><h2>What this book teaches</h2><p>Rust API design is the art of turning behavioral promises into types. A signature can describe ownership, mutation, absence, failure, concurrency, extensibility, and compatibility. The best APIs do this without making ordinary use feel ceremonial.</p><p>This book studies those choices in real libraries. We begin with Option and Result, work through ownership and iterators, then examine builders, Serde, Tokio, Axum, Tower, retry, and long-term API evolution. The aim is not to memorize patterns. It is to develop judgment about tradeoffs.</p></section>
